...
import profileImage from "../../assets/new-picture.jpg";
      ...
      <div className="flex flex-col-reverse items-center justify-between md:flex-row">
        ...
        <div className="mt-8 text-center md:w-1/2 md:text-left md:mt-0">
          ...
          <p className="mt-8 mb-10 text-base leading-relaxed text-gray-400 sm:text-lg md:text-lg">
            ...
            back-end development, I specialize in the PHP Larave , React-native
            and other modern technologies to create seamless user experiences
            and efficient solutions.
          </p>
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1UqA101HerFv_6efLC5WDs0BflGQXTdfx/view"
            target="_blank"
