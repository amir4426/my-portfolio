...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_38w3mze", // Replace with your EmailJS Service ID
        "template_1qdsf9g", // Replace with your EmailJS Template ID
        form.current,
        "w3NqdkhrE3cmU31tD" // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
